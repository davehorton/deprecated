...
DialogStart.children = [{name:'play', Klass: Play},{name:'record', Klass: Record},{name: 'dtmf', Klass: Dtmf},{name:'send',Klass:Send},{name:'exit',Klass:Exit}] ;//TODO: record, videooverlay
